...
describe("Style directive", () => {
  test("changes style", () => {
    ...
    `);
    expect(component.refs.target.style.color).toBe("red");
    color = "green";
    component.update();
    expect(component.refs.target.style.color).toBe("green");
  });
  ...
  test("leaves existing styles alone", () => {
    ...
    `);
    expect(component.refs.target.style.color).toBe("red");
    expect(component.refs.target.style.width).toBe("100px");
    color = "green";
    component.update();
    expect(component.refs.target.style.width).toBe("100px");
  });
